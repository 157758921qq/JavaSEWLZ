...
//System.out.println("子弹和坦克发生碰撞");
                ...
                //et.life -= 10;
                //list中移除
                this.tp.explodeList.add(new Explode(et.x, et.y, this.tp, et));
                return true;
            }
        }
        return false;
    ...
    //打击一辆坦克
    public boolean hitGoodTank(Tank t) {
        if(this.isLive) {    //都活着才撞击
            if(!this.isGood && this.getRect().intersects(t.getRect())){
                t.life -= 5;
//System.out.println("子弹和坦克发生碰撞");
                if(t.life <= 0) {
                ...
                //et.life -= 10;
                //list中移除
                this.tp.explodeList.add(new Explode(t.x, t.y, this.tp, t));
                return true;
            }
        }
        return false;
